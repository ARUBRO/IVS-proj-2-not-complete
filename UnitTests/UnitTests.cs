...
namespace MathHeadTest
{
    ...
    public class UnitTests
    {
        ...
        public void Function_Add()
        {
            ...
            Assert.AreEqual(-1, mh.Add(1, -2));
            Assert.AreNotEqual(10, mh.Add(5, 6));
            Assert.AreEqual(984, mh.Add(983, 1));
            Assert.AreEqual(2000, mh.Add(1965, 35));
            Assert.AreEqual(-100, mh.Add(-50, -50));
            Assert.AreEqual(0, mh.Add(-659, 659));
            Assert.AreEqual(0, mh.Add(0, 0));
            Assert.AreEqual(-50, mh.Add(-78, 28));
            Assert.AreEqual(450000000, mh.Add(400000000, 50000000));
            Assert.AreEqual(-300000000, mh.Add(-150000000, -150000000));
